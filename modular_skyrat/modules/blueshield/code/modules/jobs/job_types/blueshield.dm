/datum/job/blueshield
	...
	access = list(ACCESS_SECURITY, ACCESS_SEC_DOORS, ACCESS_BRIG, ACCESS_COURT, \
			            ACCESS_MEDICAL, ACCESS_ENGINE, ACCESS_HEADS, ACCESS_KEYCARD_AUTH, \
			            ACCESS_MAINT_TUNNELS, ACCESS_CONSTRUCTION, ACCESS_MORGUE, \
			            ACCESS_RESEARCH, ACCESS_CARGO, \
			            ACCESS_RC_ANNOUNCE, ACCESS_WEAPONS, ACCESS_BLUESHIELD)
	minimal_access = list(ACCESS_SEC_DOORS, ACCESS_MEDICAL, ACCESS_CONSTRUCTION, ACCESS_ENGINE, ACCESS_MAINT_TUNNELS, ACCESS_RESEARCH,
			            ACCESS_RC_ANNOUNCE, ACCESS_HEADS, ACCESS_KEYCARD_AUTH, ACCESS_BLUESHIELD, ACCESS_WEAPONS)
